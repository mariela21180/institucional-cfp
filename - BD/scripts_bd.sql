...
insert into telefono values (2, 0249, 4420983, 2);
insert into telefono values (3, 0249, 154997785, 3);

insert into persona values (1, "Mariela", "Gonzalez", 28200912, "mariela@gmail.com", 1, 1);
insert into persona values (2, "Juan", "Salerno", 2000000, "juan@gmail.com", 2, 2);
insert into persona values (3, "Nahum", "Larzabal", 2000001, "nahum@gmail.com", 3, 3);
...
insert into curso values (1, "Programador Full-Stack", "-", 30, 0.8, 180.5, "2019-01-02", "2019-12-02", 1);
...
insert into examen values (1, 5.8, 1, 1, 1);

insert into tipo_pregunta values (1, "Texto");

insert into pregunta values (1, 1, "¿Como me llamo?", 1, 2.5, 1, 1);

insert into opcion values (1, "Mariela", 1, 2.5, 1);
